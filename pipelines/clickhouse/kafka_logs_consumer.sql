...
CREATE TABLE bsc.logs_kafka_consumer
(
    -- Avro value（完整反序列化）
    -- ========= 业务字段 =========
    block_height    Int64,
...
SETTINGS
    ...
    kafka_topic_list  = 'blockchain.bsc.ingestion.logs.raw',
    kafka_group_name  = 'ch_bsc_logs_consumer',
    kafka_format      = 'AvroConfluent',
    format_avro_schema_registry_url  = 'http://redpanda.kafka.svc:8081',
    kafka_num_consumers = 1;

--2. create target table
CREATE TABLE bsc.logs_raw
(
    -- ========= 业务字段 =========
    block_height      Int64,
    job_name          String,
...
CREATE MATERIALIZED VIEW bsc.mv_logs_raw_pipeline
TO bsc.logs_raw
AS
SELECT
    block_height,
