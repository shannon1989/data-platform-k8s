...
class JsonFormatter(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
        ...
        # Collect fields injected via extra (excluding built-in fields).
...
# -----------------------------
RPC_API_KEY = os.getenv("BLOCKPI_API_KEY", "<YOUR-API-KEY>")
RPC_BASE_URL = "https://bsc.blockpi.network/v1/rpc"
BSC_RPC_URL = f"{RPC_BASE_URL}/{RPC_API_KEY}"
