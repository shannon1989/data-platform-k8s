...
from src.batch_executor import SerialBatchExecutor, BatchContext
# -----------------------------
...
# Behavior Control
# -----------------------------
# If True -> resume from last processed block using Kafka state topic, if False -> start from latest block
